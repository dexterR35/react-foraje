const seoData = {
  "/": {
    title: "Foraje Puțuri Apă de Mică sau Medie Adâncime | puturi-foraje.ro",
    description:
      "Foraje puțuri pentru uz casnic, șantier, irigații și denisipări profesionale. Servicii complete cu peste 15 ani experiență.",
    keywords:
  ...
  "/servicii": {
    ...
    description:
      "Descoperă serviciile noastre complete: foraje puțuri pentru uz casnic, șantier, irigații, denisipări, prelungiri și foraje piloni.",
    keywords:
